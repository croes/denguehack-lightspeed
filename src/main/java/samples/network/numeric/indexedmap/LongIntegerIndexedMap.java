...
/**
 * A map from long to integer values, which is additionally indexed to be able to perform fast
 * look-ups in large maps.
 */
public class LongIntegerIndexedMap {
  ...
  public LongIntegerIndexedMap(String aSourceName,
  ...
  private static class SubMap {
    ...
    private SubMap(long[] aKeys, int[] aValues) {
      fKeys = aKeys;
      fValues = aValues;
    }
