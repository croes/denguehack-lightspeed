...
abstract class AbstractNVGSymbolCustomizer extends AbstractSymbolCustomizer {

  public AbstractNVGSymbolCustomizer(boolean aFireModelChange, ILcdStringTranslator aStringTranslator
  ) {
  ...
  protected Object getID(Object aSymbol) {
    if ( aSymbol instanceof TLcdNVG20SymbolizedContent ) {
      Object symbol = NVGCustomizerFactory.retrieveMilitarySymbol(((TLcdNVG20SymbolizedContent) aSymbol));
      return symbol == null ? aSymbol : MilitarySymbolFacade.getSIDC(symbol);
    }
    return aSymbol;
  }
