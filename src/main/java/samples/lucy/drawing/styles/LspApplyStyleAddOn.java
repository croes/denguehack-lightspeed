...
/**
 * Lightspeed version of {@link ApplyStyleAddOn}
 */
public class LspApplyStyleAddOn extends ApplyStyleAddOn {
  private TLcyLspDrawingAddOn fDrawingAddOn;

  @Override
  public void plugInto(ILcyLucyEnv aLucyEnv) {
    fDrawingAddOn = aLucyEnv.retrieveAddOnByClass(TLcyLspDrawingAddOn.class);
    if (fDrawingAddOn == null) {
      throw new RuntimeException("Can not find the TLcyLspDrawingAddOn. Please load the drawing add-on before loading the LspApplyStyleAddOn");
    }
