...
/**
 * Extension of TLcdCompositeUndoable that uses the I18N features of Lucy to create the undo and
 * redo display names.
 */
public class CompositeUndoable extends TLcdCompositeUndoable implements ILcdUndoableListener {

  public CompositeUndoable(String aDisplayName) {
    super(aDisplayName,
  ...
  public void undoableHappened(TLcdUndoableEvent aEvent) {
    addUndoable(aEvent.getUndoable());
  }
}
