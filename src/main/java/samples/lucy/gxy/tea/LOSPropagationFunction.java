...
/**
 * Custom LOS radar propagation function
 */
public class LOSPropagationFunction extends TLcdLOSRadarPropagationFunction {

  public LOSPropagationFunction() {
    super(TLcdEarthRepresentationMode.SPHERICAL_FIXED_RADIUS,
          new ALcdTerrainElevationProvider() {
            @Override
