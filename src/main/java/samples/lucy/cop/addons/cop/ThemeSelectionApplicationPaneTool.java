...
/**
 * {@code ALcyApplicationPaneTool} extension which contains the theme
 * selector UI
 */
final class ThemeSelectionApplicationPaneTool extends ALcyApplicationPaneTool {

  ThemeSelectionApplicationPaneTool(ALcyProperties aProperties, String aLongPrefix, String aShortPrefix) {
    super(aProperties, aLongPrefix, aShortPrefix);
  }

  @Override
  protected Component createContent() {
    return new ThemeSelectorPanel(getShortPrefix(),
                                  getProperties(),
                                  getLucyEnv(),
