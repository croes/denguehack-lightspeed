...
/**
 * <p>
 *   Add-on which provides the functionality to decode the waypoint models.
 * </p>
 *
 * <p>
 *   The {@link samples.lucy.fundamentals.waypoints.WayPointsAddOn} provides visualization
 *   support for the waypoint models.
 * </p>
 */
public class WayPointsModelAddOn extends ALcyFormatAddOn {
  public WayPointsModelAddOn() {
    super(ALcyTool.getLongPrefix(WayPointsModelAddOn.class),
          ALcyTool.getShortPrefix(WayPointsModelAddOn.class));
  }

  @Override
  protected ALcyFormat createBaseFormat() {
    return new WayPointsModelFormat(getLucyEnv(), getLongPrefix(), getShortPrefix(), getPreferences());
  }
