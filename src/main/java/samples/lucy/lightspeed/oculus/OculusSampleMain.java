...
/**
 * This sample demonstrates how to open an Oculus view.
 */
public class OculusSampleMain {
  public static void main(String[] args) {
    String[] new_args = new String[args.length + 2];
    System.arraycopy(args, 0, new_args, 0, args.length);
    new_args[new_args.length - 2] = "-addons";
    new_args[new_args.length - 1] = "samples/lightspeed/oculus/addons_lightspeed_oculus_sample.xml";
