 ...
 */
package samples.lucy.symbology.gxy.app6;
...
/**
 * {@link ALcyFormatBarFactory} that creates the format bar for APP-6 layers.
 * This class shows how a format bar factory for APP-6 can be created.
 */
public class GXYAPP6FormatBarFactory extends GXYSymbologyFormatBarFactory {

  public GXYAPP6FormatBarFactory(ALcyFormat aSymbologyFormat,
