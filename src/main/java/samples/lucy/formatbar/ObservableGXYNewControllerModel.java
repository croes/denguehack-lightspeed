...
/**
 * {@link ALcyGXYNewControllerModel} that allows to add action listeners that are informed when
 * a new object has been added to a layer.
 */
public abstract class ObservableGXYNewControllerModel extends ALcyGXYNewControllerModel implements ILcdCloneable {

  private List<ActionListener> fListeners;

  public ObservableGXYNewControllerModel(TLcyCreateGXYLayerAction aCreateLayerAction, ILcyMapComponent aMapComponent) {
  ...
  @Override
  public ObservableGXYNewControllerModel clone() {
    try {
      ObservableGXYNewControllerModel result = (ObservableGXYNewControllerModel) super.clone();
