 ...
 */
package samples.geometry.topology.ellipsoidal;
...
/**
 * This sample demonstrates topological relations between states and flight trajectories using ellipsoidal topology.
 */
public class MainPanel extends GXYSample {
  ...
  protected void addData() {
    ...
    listener.setTopology(new TLcdEllipsoidalAdvancedBinaryTopology(new TLcdEllipsoid()));
    ...
    GXYDataUtil.instance().model("Data/Shp/Usa/trajectories_small.shp").layer(new TopologyRiversLayerFactory(listener)).label("Trajectories").addToView(view);
  }

  public static void main( final String[] aArgs ) {
    startSample(MainPanel.class, "Ellipsoidal Geometry");
  }
}
