...
import static samples.wmts.client.gxy.WMTSLayerFactory.setVisible;
 ...
 * You can use that sample to load a WMTS URL.
 *
 * @since 2013.0

 */
@LcdService(service = ILspLayerFactory.class)
public class WMTSLayerFactory extends UnstyledLayerFactory {
   ...
   */
  WMTSLayerFactory(ALspSingleLayerFactory aSingleLayerFactory, int aMaxVisibleLayers) {
  ...
  public boolean canCreateLayers(ILcdModel aModel) {
    return aModel.getModelDescriptor() instanceof TLcdWMTSModelDescriptor;
  }
