 ...
 */
package samples.encoder.informix.spatial;

import com.luciad.format.informix.spatial.TLcdInformixSpatialModelEncoder;
...
/**
 * This utility decodes a shape file and encodes it in a new Informix Spatial table.
 * The source file is specified by its file name.
 * The destination table is specified by an <code>isd</code> property file.
 * <p/>
 * Usage: java samples.encoder.informix.spatial.Convertor shp_file isd_file
 * <p>
...
public class Converter {
  ...
  public static void main(String[] aArgs) throws Exception {
    ...
    ILcdModelEncoder modelEncoder = new TLcdInformixSpatialModelEncoder();
    modelEncoder.export(model, destination);
  }

  private static void usage(String aErrorMessage) {
    System.err.println(aErrorMessage);
    System.err.println("Decodes a vector file and encodes it in a new Informix Spatial table.");
    System.err.println("Arguments: <input-file-name> <destination-file-name>");
    System.err.println("The destination file should have the isd extension.");
