 ...
 */
package samples.encoder.mssql;

import com.luciad.format.mssql.TLcdMSSQLModelEncoder;
...
/**
 * This utility decodes a shape file and encodes it in a new Microsoft SQL
 ...
 * The destination table is specified by an <code>mss</code> property file.
 * <p/>
 * Usage: <code>java samples.encoder.mssql.Converter</code> &lt;shp_file|mss_file&gt;
 * &lt;mss_file&gt;
 * <p/>
 * The JDBC driver to access the MSSQL database (com.microsoft.sqlserver.jdbc.SQLServerDriver)
...
public class Converter {
  ...
  public static void main(String[] aArgs) throws Exception {
    ...
    ILcdModelEncoder modelEncoder = new TLcdMSSQLModelEncoder();
    modelEncoder.export(model, destination);
  }

  private static void usage(String aErrorMessage) {
    System.err.println(aErrorMessage);
    System.err.println("Required arguments: input_file output_file.mss");
