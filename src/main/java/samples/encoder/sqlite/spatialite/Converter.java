 ...
 */
package samples.encoder.sqlite.spatialite;

import com.luciad.format.sqlite.spatialite.TLcdSpatiaLiteModelEncoder;
...
/**
 * This utility decodes a shape file and encodes it in a new SQLite SpatiaLite
 ...
 * The destination table is specified by an <code>spl</code> property file.
 * <p/>
 * Usage: <code>java samples.encoder.sqlite.Converter</code> &lt;shp_file|spl_file&gt; &lt;spl_file&gt;
 * <p/>
 * The JDBC driver to access the SQLite database (org.sqlite.Driver)
...
public class Converter {
  ...
  public static void main(String[] aArgs) throws Exception {
    ...
    ILcdModelEncoder modelEncoder = new TLcdSpatiaLiteModelEncoder();
  ...
  private static void usage(String aErrorMessage) {
    ...
    System.err.println("The destination file should have the spl extension.");
