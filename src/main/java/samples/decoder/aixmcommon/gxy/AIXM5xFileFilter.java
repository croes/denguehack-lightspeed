...
/**
 * Extension of <code>FileFilter</code> that accepts files with typical AIXM5.x
 * extensions.
 */
public class AIXM5xFileFilter extends FileFilter {

  public static final String DEFAULT_EXTENSION = "xml";
  private static final String[] ALL_EXTENSIONS = { "xml", "aixm51", "aixm", "aixm5" };
