...
/**
 * Extension of TLcdForceBasedLabelingAlgorithm that puts the labels
...
public class HeadingSensitiveDeclutterer extends TLcdGXYContinuousLabelingAlgorithm {
  ...
  private final Rectangle fLabelBounds = new Rectangle();
  ...
  protected void retrieveDesiredLabelLocation(Graphics aGraphics,
    ...
    //We know it is a TLcdASTERIXTrack as the layer we set this painter to
    //only contains objects of that type.
    TLcdASTERIXTrack track = (TLcdASTERIXTrack) aObject;

    double orientation = TrackGXYPainter.getTrackOrientation(
