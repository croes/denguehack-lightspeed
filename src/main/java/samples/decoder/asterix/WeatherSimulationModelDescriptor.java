...
public class WeatherSimulationModelDescriptor extends SimulationModelDescriptor {
   ...
   *                     model.
   */
  public WeatherSimulationModelDescriptor(String aSourceName, String aTypeName, String aDisplayName, TLcdDataType aDataType) {
