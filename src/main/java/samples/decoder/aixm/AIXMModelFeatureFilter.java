...
import com.luciad.format.aixm.util.ILcdAIXMModelFilter;
import com.luciad.model.ILcdModelDescriptor;

/**
 * This class demonstrates filtering of AIXM data. It defines a filter that uses
 * a specific property and property value to accept objects.
 * <p/>
 ...
 * <p/>
 */
class AIXMModelFeatureFilter implements ILcdAIXMModelFilter {

  private TLcdDataProperty fProperty;
  private Object fPropertyValue; 


  //methods of ILcdAIXMModelFilter
  /**
   * This method has no effect. You don't need to call it.
   *
   * @param aModelDescriptor not relevant
   */
