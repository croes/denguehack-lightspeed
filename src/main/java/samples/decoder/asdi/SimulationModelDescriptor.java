...
/**
 * Model descriptor used to identify the simulation models.
 */
public class SimulationModelDescriptor implements ILcdModelDescriptor, ILcdDataModelDescriptor {

  private final ALcdASDIModelDescriptor fStaticDataDescriptor;
  private final String fSourceName;
  private final String fTypeName;
  private final String fDisplayName;
  private final ILcdSimulatorModel fSimulatorModel;
   ...
   * layer.
   * @param aStaticDataDescriptor The descriptor of the original, static model.
   * @param aSimulatorModel The simulator model related to this descriptor.
   * @param aDataType The data type of the elements of this model
   */
  public SimulationModelDescriptor(
      String aSourceName, String aTypeName, String aDisplayName,
      ALcdASDIModelDescriptor aStaticDataDescriptor,
    ...
    fStaticDataDescriptor = aStaticDataDescriptor;
  ...
  public ALcdASDIModelDescriptor getStaticDataDescriptor() {
    return fStaticDataDescriptor;
  }

  public ILcdSimulatorModel getSimulatorModel() {
    return fSimulatorModel;
  }
