...
/**
 * A simple layer factory for models containing polylines.
 */
public class IsobarLayerFactory implements ILcdGXYLayerFactory {
  ...
  public ILcdGXYLayer createGXYLayer( ILcdModel aModel ) {
    ...
    painter.setLineStyle( new TLcdGXYPainterColorStyle( Color.black ) );
