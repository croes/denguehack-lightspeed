...
public class AdvancedTimeToolbarSimulatorModel extends TimeToolbarModel implements IntervalSimulatorModel {
  /**
   ...
   */
  public AdvancedTimeToolbarSimulatorModel( ILcdLayered aLayered ) {
    super( aLayered );
  }
