...
public class KMLLayerFactory extends ALspSingleLayerFactory {
  @Override
  public ILspLayer createLayer( ILcdModel aModel ) {
    return TLspKML22LayerBuilder.newBuilder().model( aModel ).build();
  }

  @Override
  public boolean canCreateLayers( ILcdModel aModel ) {
    return aModel.getModelDescriptor() instanceof TLcdKML22ModelDescriptor;
  }
}
