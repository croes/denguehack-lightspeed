...
/**
 * This sample demonstrates how to display a DTED in a 3D view, taking into
 * account the height values of the DTED.
 * <p/>
 * Use the Z slider on the right to change the scale of the Z values.
 */
public class MainApplet extends Abstract3DSample {
  ...
  public static void main( final String[] aArgs ) {
    EventQueue.invokeLater( new Runnable() {
      public void run() {
        try {
          new LuciadFrame(new MainApplet(), "Luciad3D DTED Sample" );
