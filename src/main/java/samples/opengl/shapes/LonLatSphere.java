 ...
 * sphere.
 */
class LonLatSphere extends TLcdLonLatCircle {

  public LonLatSphere() {
  }

  public LonLatSphere( TLcdLonLatCircle aCircle ) {
    super( aCircle );
  }

  public LonLatSphere( ILcdPoint aPoint, double v, ILcdEllipsoid aEllipsoid ) {
    super( aPoint, v, aEllipsoid );
  }

  public LonLatSphere( double v, double v1, double v2, ILcdEllipsoid aEllipsoid ) {
