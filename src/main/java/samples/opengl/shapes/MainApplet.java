...
/**
 * This sample shows how the different implementations of ILcdGLPaintableFactory
 * can be used to display ILcdShape objects in 3D. Each basic shape is drawn in a flat
 * form and in an extruded form.
 */
public class MainApplet extends Abstract3DSample {
  ...
  public static void main( final String[] aArgs ) {
    EventQueue.invokeLater( new Runnable() {
      public void run() {
        try {
          new LuciadFrame(new MainApplet(), "Luciad3D Shapes Sample" );
