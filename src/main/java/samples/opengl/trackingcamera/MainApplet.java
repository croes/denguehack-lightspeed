...
/**
 * Sample demonstrating the use of the {@link com.luciad.view.opengl.ALcdGLTrackingCamera}
 * to implement cameras that automatically follow a moving target.
 */
public class MainApplet extends Abstract3DSample {
  ...
  public static void main( final String[] aArgs ) {
    EventQueue.invokeLater( new Runnable() {
      public void run() {
        try {
          new LuciadFrame(new MainApplet(), "Luciad3D Tracking Camera Sample" );
