...
/**
 * This sample demonstrates the use of TLcdGL3DIconPainter to draw 3D objects
 * instead of simple 2D icons.
 */
public class MainApplet extends Abstract3DSample {
  ...
  public static void main( String[] aArgs ) {
    EventQueue.invokeLater( new Runnable() {
      public void run() {
        try {
          new LuciadFrame(new MainApplet(), "Luciad3D Stereoscopic View Sample", 640, 480 );
