...
class ModelFactory {
  ...
  public static ILcdModel createPointModel() {
    ...
    p = new OrientedLonLatHeightPoint( -0.3, -0.3, 100, 45, -10, 10 );
    model.addElement( p, ILcdFireEventMode.NO_EVENT );

    p = new OrientedLonLatHeightPoint( 0, 0, 500, 0, 0, 0 );
    model.addElement( p, ILcdFireEventMode.NO_EVENT );

    p = new OrientedLonLatHeightPoint( 0.3, 0.3, 1000, -45, 10, -10 );
    model.addElement( p, ILcdFireEventMode.NO_EVENT );
