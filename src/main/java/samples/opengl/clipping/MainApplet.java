...
/**
 * This sample demonstrates how user defined clipping planes can be added
 * to the 3D view. This allows you to cut portions of the view away.
 */
public class MainApplet extends Abstract3DSample {
  ...
  public static void main( final String[] aArgs ) {
    EventQueue.invokeLater( new Runnable() {
      public void run() {
        try {
          new LuciadFrame(new MainApplet(), "Luciad3D Clipping Planes Sample" );
