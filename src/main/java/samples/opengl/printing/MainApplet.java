...
/**
 * This sample is based on 'firstSample' but adds functionality for printing
 * the 3D view. This added functionality is located in the constructor of
 * MainPanel. Other changes are the addition of some labels to the ellipses.
 */
public class MainApplet extends Abstract3DSample {
  ...
  public static void main( final String[] aArgs ) {
    EventQueue.invokeLater( new Runnable() {
      public void run() {
        try {
          new LuciadFrame(new MainApplet(), "Luciad3D printing sample" );
