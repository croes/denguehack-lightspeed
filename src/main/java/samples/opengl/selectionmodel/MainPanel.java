...
/**
 * The main panel of the selection model sample.
 */
class MainPanel extends Abstract3DPanel {
  ...
  protected void createGUI() {
    ...
    TLcdGLSelectionController selection_controller = getToolbar().getSelectionController();
    selection_controller.setSelectionModel( new RearmostSelectionModel() );
    getCanvas().setController( selection_controller );
  }
