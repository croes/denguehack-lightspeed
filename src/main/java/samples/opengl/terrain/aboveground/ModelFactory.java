...
class ModelFactory {
  ...
  public static ILcdModel createTerrainModel() throws IOException {
    TLcdTerrainModelDecoder decoder = new TLcdTerrainModelDecoder();
    return decoder.decode( "Data/terrain_sample/alps.trn" );
  }

  public static ILcdModel createPolylineModel() throws IOException {
    TLcdSHPModelDecoder decoder = new TLcdSHPModelDecoder();
    return decoder.decode( "Data/aboveGround/alps_rivers.shp" );
  }
}
