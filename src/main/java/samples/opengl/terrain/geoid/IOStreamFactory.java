...
/**
 * This class implements both ILcdInputStreamFactory and ILcdOutputStreamFactory. It is used to
 * preprocess a terrain in memory. A hash table is used to couple each created OutputStream to an
 * InputStream that can retrieve the written data later on.
 */
