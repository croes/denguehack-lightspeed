 ...
 */
public class SelectionToggleFillStyleProvider implements ILcdGLObjectStyleProvider<TLcdGLFillStyle> {

  private final ILcdGLObjectStyleProvider<TLcdGLFillStyle> fDefaultStyleProvider;
  private final ILcdGLObjectStyleProvider<TLcdGLFillStyle> fSelectionStyleProvider;

  public SelectionToggleFillStyleProvider( ILcdGLObjectStyleProvider<TLcdGLFillStyle> aADefaultStyleProvider, ILcdGLObjectStyleProvider<TLcdGLFillStyle> aASelectionStyleProvider ) {
    super();
    fDefaultStyleProvider = aADefaultStyleProvider;
    fSelectionStyleProvider = aASelectionStyleProvider;
  }
