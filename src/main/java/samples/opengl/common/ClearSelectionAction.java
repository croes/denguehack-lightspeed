 ...
 * @since 10.0
 */
public class ClearSelectionAction extends ALcdAction {

  private ILcdGLView fGLView;

  public ClearSelectionAction( ILcdGLView aGLView ) {
    super( "Clear Selection" );
    fGLView = aGLView;
  }

  public void actionPerformed( ActionEvent e ) {
    Enumeration layers = fGLView.layers();
    while( layers.hasMoreElements() ) {
      ILcdGLLayer layer = ( ILcdGLLayer ) layers.nextElement();
      Enumeration selection = layer.selectedObjects();
