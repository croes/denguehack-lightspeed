...
/**
 * This sample demonstrates the various options for labeling objects in a 3D
 * view. It uses all supplied label painter implementations, as well as an
 * extension of TLcdGLLabelPainter which scales the label font size with
 * distance.
 */
public class MainApplet extends Abstract3DSample {
  ...
  public static void main( final String[] aArgs ) {
    EventQueue.invokeLater( new Runnable() {
      public void run() {
        try {
          new LuciadFrame(new MainApplet(), "Luciad3D Labeling Sample" );
