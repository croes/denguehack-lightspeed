...
/**
 * This sample demonstrates how a geocentric world reference can be used in the
 * 3D view to create a 3D globe instead of a typical "2.5D" map.
 */
public class MainApplet extends Abstract3DSample {
  ...
  public static void main( final String[] aArgs ) {
    EventQueue.invokeLater( new Runnable() {
      public void run() {
        try {
          new LuciadFrame(new MainApplet(), "Luciad3D Geocentric Sample" );
