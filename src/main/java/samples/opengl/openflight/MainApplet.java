...
/**
 * This sample demonstrates the use of the com.luciad.format.openflight package.
 */
public class MainApplet extends Abstract3DSample {
  ...
  protected void createGUI() {
    ...
    SwingUtilities.invokeLater( new Runnable() {
      public void run() {
        JOptionPane.showMessageDialog( MainApplet.this, new String[] {
                "The Luciad3D distribution does not contain OpenFlight data.",
  ...
  public static void main( final String[] aArgs ) {
    EventQueue.invokeLater( new Runnable() {
      public void run() {
        try {
          new LuciadFrame(new MainApplet(), "Luciad3D OpenFlight decoder sample" );
