...
/**
 * This sample simulates taking snapshots of the Earth from a satellite.
 * The saved snapshots can be used as input for the orthorectification
 * samples.
 */
public class MainApplet extends Abstract3DSample {
  ...
  public static void main(final String[] aArgs) {
    EventQueue.invokeLater(new Runnable() {
      public void run() {
        try {
          new LuciadFrame(new MainApplet(), "Satellite View");
