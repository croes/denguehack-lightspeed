...
/**
 * This sample demonstrates how to create a custom paintable factory.
 * FlagPaintableFactory creates flag like geometries using ILcdPoint objects as
 * domain objects.
 */
public class MainApplet extends Abstract3DSample {
  ...
  public static void main( final String[] aArgs ) {
    EventQueue.invokeLater( new Runnable() {
      public void run() {
        try {
          new LuciadFrame(new MainApplet(), "Luciad3D Paintable Factory Sample" );
