 ...
 */
class OrientationLonLatHeightPoint extends TLcdLonLatHeightPoint implements ILcd3DOrientationSettable {

  private double fYaw = 0;
  private double fPitch = 0;
  private double fRoll = 0;

  public OrientationLonLatHeightPoint(double aX, double aY, double aZ, double aYaw, double aPitch, double aRoll) {
    super(aX, aY, aZ);
    fYaw = aYaw;
    fPitch = aPitch;
    fRoll = aRoll;
