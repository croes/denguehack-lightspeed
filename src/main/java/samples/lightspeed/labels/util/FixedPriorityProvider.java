...
/**
 * Priority provider that always returns the same given priority.
 */
public class FixedPriorityProvider implements ILspLabelPriorityProvider {

  private final int fPriority;

  public FixedPriorityProvider(int aPriority) {
    fPriority = aPriority;
  }
