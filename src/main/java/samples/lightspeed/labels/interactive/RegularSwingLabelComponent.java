...
public class RegularSwingLabelComponent extends samples.gxy.labels.interactive.RegularSwingLabelComponent implements LabelComponentProvider {

  public RegularSwingLabelComponent(Map<Object, String> aCitiesCommentMap) {
    super(aCitiesCommentMap);
  }
