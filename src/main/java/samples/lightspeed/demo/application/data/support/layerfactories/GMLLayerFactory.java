...
/**
 * Layer factory for GML models.
 */
public class GMLLayerFactory extends AbstractLayerFactory {
  ...
  public boolean canCreateLayers(ILcdModel aModel) {
    return aModel.getModelDescriptor() instanceof TLcdGMLModelDescriptor;
  }
}
