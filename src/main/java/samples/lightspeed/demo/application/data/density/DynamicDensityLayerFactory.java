 ...
 * </table>
 */
public class DynamicDensityLayerFactory extends AbstractLayerFactory {
  ...
  public boolean canCreateLayers(ILcdModel aModel) {
    return aModel instanceof ILcd2DBoundsIndexedModel &&
           ...
           Framework.getInstance().getThemeByClass(DensityTheme.class) != null;
  }
  ...
  private ILcdModel getTrackModel(ILcdModel aModel) {
    ...
    try (Lock autoUnlock = writeLock(aModel)) {
      DensityTheme densityTheme = Framework.getInstance().getThemeByClass(DensityTheme.class);
