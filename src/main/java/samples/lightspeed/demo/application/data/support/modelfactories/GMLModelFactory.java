...
/**
 * Model factory to create GML models.
 */
public class GMLModelFactory extends AbstractModelFactory {

  private TLcdGMLModelDecoder fDecoder = new TLcdGMLModelDecoder();

  public GMLModelFactory(String aType) {
    super(aType);
  }

  @Override
  public ILcdModel createModel(String aSource) throws IOException {
    return fDecoder.decode(aSource);
  }
}
