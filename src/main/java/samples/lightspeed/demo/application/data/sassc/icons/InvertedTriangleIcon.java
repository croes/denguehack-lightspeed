...
public class InvertedTriangleIcon extends TriangleIcon {

  protected InvertedTriangleIcon(int size, Color lineColor, Color fillColor) {
    super(size, lineColor, fillColor);
  }
