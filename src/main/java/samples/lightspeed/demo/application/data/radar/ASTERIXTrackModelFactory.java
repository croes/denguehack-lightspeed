...
public class ASTERIXTrackModelFactory extends AbstractModelFactory {

  private TLcdASTERIXModelDecoder fDecoder = new TLcdASTERIXModelDecoder();

  public ASTERIXTrackModelFactory(String aType) {
    super(aType);
  }
