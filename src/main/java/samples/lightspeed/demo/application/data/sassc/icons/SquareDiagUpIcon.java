...
public class SquareDiagUpIcon extends SquareIcon {

  private Color leftColor;
  private Color rightColor;

  protected SquareDiagUpIcon(int aSize, Color aLineColor, Color aLeftColor, Color aRightColor) {
  ...
  @Override
  public Object clone() {
    return new SquareDiagUpIcon(size, lineColor, leftColor, rightColor);
  }
}
