...
public class DiamondHorizontalLineIcon extends DiamondIcon {

  protected DiamondHorizontalLineIcon(int size, Color color) {
    super(size, color);
  }
  ...
  protected static void paint(int aSize, Graphics aGraphics, Color aColor, int x, int y) {
    ...
    aGraphics.drawLine(x, y + axisModificator, x + 2 * axisModificator, y + axisModificator);
  }
}
