...
public class HoursGlassHorizontalIcon extends SASSCIcon {

  private Color leftColor;
  private Color rightColor;

  protected HoursGlassHorizontalIcon(int aSize, Color aLineColor, Color aLeftColor, Color aRightColor) {
  ...
  @Override
  public Object clone() {
    return new HoursGlassHorizontalIcon(size, lineColor, leftColor, rightColor);
  }
  ...
  protected static Polygon createPolygon(int aSize, int x, int y, boolean left) {
