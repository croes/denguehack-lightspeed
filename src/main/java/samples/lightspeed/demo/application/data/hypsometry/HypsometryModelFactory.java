...
/**
 * Factory that creates models that provide capabilities for hypsometry.
 */
public class HypsometryModelFactory extends AbstractModelFactory {

  public HypsometryModelFactory(String aType) {
    super(aType);
  }

  @Override
  public ILcdModel createModel(String aSource) throws IOException {
    TLcdDEMModelDecoder decoder = new TLcdDEMModelDecoder(TLcdSharedBuffer.getBufferInstance());
