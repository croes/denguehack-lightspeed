...
/**
 * A factory for panels for themes.
 */
public interface IThemePanelFactory {

  /**
   * Creates a list of panels for the given theme.
   *
   * @param aTheme the theme for which the panels are created
   *
