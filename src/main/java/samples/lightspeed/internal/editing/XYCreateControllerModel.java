...
import com.luciad.shape.shape3D.TLcdXYZ3DArcBand;
 ...
 * @since 2012.0
 */
public class XYCreateControllerModel extends ALspCreateControllerModel {
  ...
  public static enum Type {
    ...
    private String fReadebleName;

    Type(String aReadebleName) {
      fReadebleName = aReadebleName;
    }

    @Override
    public String toString() {
      return fReadebleName;
    }
  }
  ...
  public XYCreateControllerModel(Type aType, ILspInteractivePaintableLayer aLayer) {
    fLayer = aLayer;
    fType = aType;
  ...
  public Object create(ILspView aView, ILspLayer aLayer) {
    ...
    case ARC_BAND_3D:
      TLcdXYZ3DArcBand arcBand = new TLcdXYZ3DArcBand();
      arcBand.setPitchArcAngle(30);
      return arcBand;
    case ARC:
      if (!isCreateExtrudedShape()) {
        return createXYArc();
