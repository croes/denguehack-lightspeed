...
/**
 * Abstract base class for single- and multi-valued long record columns.
 *
 * @author Bruno Christiaen
 */
public abstract class ASasLongRecordColumn extends ASasRecordColumn {

  /**
   * Long value used to represent NULL in DB.
   */
   ...
   */
  public ASasLongRecordColumn(TSasDbExpressionDefinition aDefinition) {
    super(aDefinition);
  }
  ...
  /**
   * Long value used to indicate a NULL value in the database.
   * @return The value.
   */
  public static long getNullValue() {
    return NULL_VALUE;
  }
   ...
   */
  protected static long parseDBValue(Object aValue) {
    long value;
    if (aValue == null) {
      value = NULL_VALUE;
    } else {
      value = ((Number) aValue).longValue();
    }
    return value;
  }
}
