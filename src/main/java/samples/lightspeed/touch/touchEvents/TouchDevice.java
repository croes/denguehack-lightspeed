...
public class TouchDevice {
  ...
  public void start() {
    ...
    List<DeviceEvent> device_events = new ArrayList<DeviceEvent>();

    // Pan the view.
    device_events.addAll(generateTouchStroke(new Point(100, 100), new Point(150, 150), 1000, 1500, 10));

    // Zoom in.
    device_events.addAll(generateTouchStroke(new Point(550, 375), new Point(350, 375), 2000, 2500, 10));
    device_events.addAll(generateTouchStroke(new Point(650, 375), new Point(850, 375), 2000, 2500, 10));

    // Rotate the view.
    device_events.addAll(generateTouchStroke(new Point(400, 375), new Point(600, 175), 3000, 3500, 10));
    device_events.addAll(generateTouchStroke(new Point(800, 375), new Point(600, 575), 3000, 3500, 10));

    // Do a mixture.
    device_events.addAll(generateTouchStroke(new Point(600, 475), new Point(900, 475), 4000, 4500, 10));
    device_events.addAll(generateTouchStroke(new Point(650, 475), new Point(350, 475), 4160, 5000, 10));
    device_events.addAll(generateTouchStroke(new Point(400, 575), new Point(800, 575), 4750, 5500, 10));
  ...
  /**
   * Action listener that schedules events and activates listeners of events.
   */
