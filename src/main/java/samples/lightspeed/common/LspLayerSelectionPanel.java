...
import samples.common.LayerSelectionPanel;
...
public class LspLayerSelectionPanel extends LayerSelectionPanel<ILspLayer> {
  ...
  public LspLayerSelectionPanel(ILspAWTView aView, boolean aFitOnSelection, Component aComponentForFailMessage) {
    this(aView.getOverlayComponent(), aView, aFitOnSelection, aComponentForFailMessage);
  }
