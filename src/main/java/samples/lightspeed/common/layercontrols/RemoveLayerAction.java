...
/**
 * Action that removes selected layers from the view.
 */
public class RemoveLayerAction extends AbstractLayerTreeAction {
  public RemoveLayerAction(ILcdTreeLayered aLayered) {
    super(aLayered);
    setShortDescription("Remove selected layer(s)");
