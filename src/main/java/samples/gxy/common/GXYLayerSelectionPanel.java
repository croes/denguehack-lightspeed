...
public class GXYLayerSelectionPanel extends LayerSelectionPanel<ILcdGXYLayer> {

  private final ILcdGXYView fView;

  public GXYLayerSelectionPanel(ILcdGXYView aView, JComponent aOverlayPanel) {
    super(aOverlayPanel);
    fView = aView;
  }
