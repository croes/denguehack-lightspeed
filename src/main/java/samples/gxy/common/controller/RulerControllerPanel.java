 ...
 */
public class RulerControllerPanel extends JPanel {
  ...
  private static final int[] MODES = {
      TLcdAdvancedMapRulerController.MEASURE_GEODETIC,
      TLcdAdvancedMapRulerController.MEASURE_RHUMBLINE,
      TLcdAdvancedMapRulerController.MEASURE_PROJECTION_PLANE
  };

  private JComboBox fComboBox;
  private TLcdAdvancedMapRulerController fRulerController;

  public RulerControllerPanel(TLcdAdvancedMapRulerController aRulerController) {
   ...
   */
  private int findIndexForMeasureMode(int aMeasureMode) {
