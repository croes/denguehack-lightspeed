...
public class LayerBasedGXYLabelingAlgorithmProvider implements ILcdGXYLabelLabelingAlgorithmProvider<ILcdGXYLabelingAlgorithm> {
  private final ILcdGXYLayer fLayer;
  private final ILcdGXYLabelingAlgorithm fAlgorithm;

  public LayerBasedGXYLabelingAlgorithmProvider(ILcdGXYLayer aLayer, ILcdGXYLabelingAlgorithm aAlgorithm) {
    fLayer = aLayer;
