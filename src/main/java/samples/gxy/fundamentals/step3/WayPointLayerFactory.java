...
public class WayPointLayerFactory implements ILcdGXYLayerFactory {
  ...
  public ILcdGXYLayer createGXYLayer(ILcdModel aModel) {
    ...
    // Creates a painter that displays the first feature of each model element.
    TLcdGXYDataObjectLabelPainter labelPainter = new TLcdGXYDataObjectLabelPainter();
    labelPainter.setExpressions(WayPointDataTypes.NAME);
