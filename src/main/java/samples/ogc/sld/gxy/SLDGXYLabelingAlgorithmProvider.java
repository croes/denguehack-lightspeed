...
/**
 * Picked up and used by GXYLabelingAlgorithmProvider.
 */
@LcdService(service = ILcdGXYLabelLabelingAlgorithmProvider.class, priority = LcdService.DEFAULT_PRIORITY)
public class SLDGXYLabelingAlgorithmProvider implements ILcdGXYLabelLabelingAlgorithmProvider<ILcdGXYLabelingAlgorithm> {

  private TLcdSLDLabelingAlgorithm fSLDAlgorithm = new TLcdSLDLabelingAlgorithm();
