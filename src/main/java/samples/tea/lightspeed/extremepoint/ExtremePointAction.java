...
class ExtremePointAction extends AbstractExtremePointAction {
   ...
   */
  public ExtremePointAction(Component aParentComponent, ILcdShape aShape, ILcdGeoReference aShapeReference, TLcdHeightProviderAdapter aAltitudeProvider) {
  ...
  public void setDTEDLevel(DTEDLevel aDTEDLevel) {
