 ...
 * for the various models in the directional viewshed sample.
 */
class ViewshedLayerFactory implements ILcdGXYLayerFactory {

  // For point layer ...
  TLcdGXYIconPainter fIconPainter1 = new TLcdGXYIconPainter();
  ILcdIcon fPointIcon1 = new TLcdSymbol( TLcdSymbol.FILLED_CIRCLE, 16, Color.orange, Color.yellow );
  ...
  private ILcdGXYLayer createGXYLayerImpl( ILcdModel aModel ) {
    ...
    if ( "Sun Position".equals( model_descriptor.getTypeName() ) ) {
      return createSunLayer( aModel );
    }
  ...
  private ILcdGXYLayer createSunLayer( ILcdModel aModel ) {
