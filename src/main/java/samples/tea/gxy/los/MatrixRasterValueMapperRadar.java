 ...
 * values from the propagation function <code>TLcdLOSRadarPropagationFunction</code>.
 * </p>
 * <p>
 ...
 * <ul>
 *   <li>normal values</li>
 *   <li>{@link TLcdLOSRadarPropagationFunction#UNKNOWN}</li>
 *   <li>{@link TLcdLOSRadarPropagationFunction#INVISIBLE}</li>
 * </ul>
 * </p>
 * <p>
 ...
 * </p>
 */
class MatrixRasterValueMapperRadar implements ILcdMatrixRasterValueMapper {

  public short getDefaultValue() {
    return TLcdLOSRadarPropagationFunction.INVISIBLE;
  }
  ...
  private short mapMatrixValueMinimum( short aOldRasterValue, double aMatrixValue ) {
    ...
    if ( aOldRasterValue == TLcdLOSRadarPropagationFunction.UNKNOWN ||
         aMatrixValue    == TLcdLOSRadarPropagationFunction.UNKNOWN ) {
      return TLcdLOSRadarPropagationFunction.UNKNOWN;
    }
    if ( aOldRasterValue == TLcdLOSRadarPropagationFunction.INVISIBLE ||
         aMatrixValue    == TLcdLOSRadarPropagationFunction.INVISIBLE ) {
      return TLcdLOSRadarPropagationFunction.INVISIBLE;
    }
  ...
  private static boolean isSpecialValue( double aValue ) {
    return aValue == TLcdLOSRadarPropagationFunction.INVISIBLE ||
           aValue == TLcdLOSRadarPropagationFunction.UNKNOWN;
  }
